  ...
  <body>
      ...
      <div class="collapse navbar-collapse justify-content-end" id="navbarNavDropdown">
        <ul class="navbar-nav">
          ...
          <li class="nav-item active btn-info">
            <a class="nav-link" href="carrinho.php">Carrinho<span class="sr-only">(página atual)</span></a>
          </li>
    ...
    <div class="container">
      ...
      <table class="table table-dark">
        ...
        <tbody>
          <?php 
            include '../controller/crudVenda.php';
            

            $resposta = consultaCarrinho();
                ...
                echo "
                  <form method='post' action='../controller/controleVendas.php'>
                    <tr>
                      ...
                      <td>$produtora</td>
                      <td>$preco</td>
                      <td><a class='btn btn-primary' href='../controller/controleVendas.php?opcao=Excluir&codigo=$codigo'>Remover</a></td>
                    </tr>
                  </form>
                ";
